        ...
        <div class="col-lg-7 mb-5">
            <div class="contact-form bg-light p-30">
                <form action="{{ route('send_message') }}" method="post" name="sentMessage" id="contactForm"
                    ...
                    <div class="control-group">
                        <input type="tel" name="phone_number" class="form-control" id="tel" placeholder="Phone number"
                            required="required" data-validation-required-message="Please enter a phone number" />
                        <p class="help-block text-danger"></p>
                    </div>
                    <div class="control-group">
                        <textarea name="message" class="form-control" rows="11" id="message" placeholder="Message"
