<template>
    ...
    <div class="container-fluid features mb-2">
        <div class="container py-5">
            <div class="row g-4">
                <div v-for="article in articles" class="col-md-6 col-lg-6 col-xl-3">
                    <div class="row g-4 align-items-center features-item">
                        <div class="col-4">
                            <div class="rounded-circle position-relative">
                                <div class="overflow-hidden rounded-circle">
                                    <img v-bind:src="article.photo"
                        ...
                        <div class="col-8">
                            <div class="features-content d-flex flex-column">
                                <p class="text-uppercase mb-2">{{ article.category_id }}</p>
                                <a href="#" class="h6">
                                    {{ articles.title }}
                                </a>
                                <small class="text-body d-block"><i class="fas fa-calendar-alt me-1"></i>{{ articles.created_at }}</small>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-4">
                <div class="col-lg-7 col-xl-8 mt-0">
                    <div class="position-relative overflow-hidden rounded">
                        <img src="" class="img-fluid rounded img-zoomin w-100" alt="">
